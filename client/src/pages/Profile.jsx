      ...
      <main className={styles.main}>
        ...
        <div className={styles.hero}>
          ...
          <div className={styles.heroText}>
            <p className={styles.heroLabel}>Account</p>
        ...
        <div className={styles.cols}>
          ...
          <div className={styles.colCard}>
            <div className={styles.colCardHeader}>
              ...
              <h2 className={styles.colCardTitle}>Account information</h2>
            </div>
            <form className={styles.form} onSubmit={handleSave}>
              <div className={styles.field}>
                <label className={styles.label}>Username</label>
                <input className={styles.input} type="text" value={username} onChange={e => setUsername(e.target.value)} placeholder="Your username" minLength={3} maxLength={50} />
              </div>
              <div className={styles.field}>
              ...
              <div className={styles.colCardHeader}>
                ...
                <h2 className={styles.colCardTitle}>Change password <span className={styles.optional}>(optional)</span></h2>
              </div>
              <div className={styles.field}>
                <label className={styles.label}>New password</label>
                <input className={styles.input} type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Leave blank to keep current" minLength={6} />
              </div>
              <div className={styles.field}>
                <label className={styles.label}>Confirm new password</label>
                <input
                  className={`${styles.input} ${password && confirmPassword && password !== confirmPassword ? styles.inputError : ''}`}
                  type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="Repeat new password"
                />
          ...
          <div className={styles.colCard}>
            <div className={styles.colCardHeader}>
              ...
              <h2 className={styles.colCardTitle}>Profile photo</h2>
            </div>
            <div className={styles.avatarCenter}>
              ...
              <p className={styles.avatarHint}>JPG, PNG, WEBP · Max 2MB</p>
            </div>

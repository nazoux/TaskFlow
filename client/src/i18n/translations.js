export const translations = {
  en: {
    ...
    auth: {
      ...
      verifyEmailDesc: (email) => `We sent a verification link to ${email}. Click it to activate your account.`,
      verifyEmailNote: 'You can close this page.',
      verifyingTitle: 'Verifying your email...',
      verifySuccess: 'Email verified! You can now log in.',
      verifyError: 'This link is invalid or has already been used.',
  ...
  fr: {
    ...
    auth: {
      ...
      verifyEmailDesc: (email) => `Nous avons envoyé un lien de vérification à ${email}. Cliquez dessus pour activer votre compte.`,
      verifyEmailNote: 'Vous pouvez fermer cette page.',
      verifyingTitle: 'Vérification en cours...',
      verifySuccess: 'Email vérifié ! Vous pouvez maintenant vous connecter.',
      verifyError: 'Ce lien est invalide ou a déjà été utilisé.',
